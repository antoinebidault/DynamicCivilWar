private ["_pos","_radius","_nb","_unit","_building","_buildings","_unitName","_posToSpawn","_posBuildings","_enemy"];
...
for "_j" from 1 to _nb do {
    ...
    _unit setVariable["IH_isIntel",true];
    _unit setVariable["IH_type","cache"];
