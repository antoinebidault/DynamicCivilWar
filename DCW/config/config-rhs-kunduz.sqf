...
RATIO_POPULATION =  .04; //Number of unit per building. 0.4 default
RATIO_CARS =  .005; //Number of empty cars spawned in a city by buidling
...
MAX_RANDOM_PATROL = 2; //Number of units patroling around the player at the same time
...
ENEMY_LEUTNANT_LIST_CARS = ["UK3CB_TKM_O_BTR60","UK3CB_TKM_O_MTLB_PKT"];  //car list used by leutnant