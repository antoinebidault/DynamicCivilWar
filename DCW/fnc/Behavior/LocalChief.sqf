...
[_this,["<t color='#660000'>Interrogate</t>",{
...
[_this,["<t color='#660000'>Set up a base here (200 points, 6 hours)</t>",{
    params["_unit","_asker","_action"];
...
[_this,["<t color='#660000'>Call in the humanitary assistance (300 points, 12 hours)</t>",{
    params["_unit","_asker","_action"];
    ...
    [[_unit,_asker,_action],{
        ...
        private _success =_curr select 3;
        if(_curr select 12 != "massacred") exitWith{[_unit,"Our village does not need any help for the moment...", false] spawn fnc_talk; false;};
        if(_curr select 13 < 70) exitWith{[_unit,"Improve your reputation first (70 minimum)", false] spawn fnc_talk; false;};
        if (!([GROUP_PLAYERS,200] call fnc_afford)) exitWith {[_unit,"You need more money !", false] spawn fnc_talk;false;};
...
[_this,["<t color='#660000'>Gives him a military advisor</t>",{
    params["_unit","_asker","_action"];
